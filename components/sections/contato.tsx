...
export function Contato() {
  ...
  return (
    <section id="contato" ref={sectionRef} className="flex flex-col items-center bg-bg-primary px-6 py-32 text-center lg:px-[clamp(24px,5vw,64px)]">
      <style>{`
      ...
      <BlurFade delay={0.1}>
        <h2 className="font-mono mt-8 max-w-[800px] font-display text-[clamp(44px,6vw,72px)] font-light leading-[1.05] tracking-[-0.035em] text-text-primary">
          Tem um projeto<br />em mente?
        </h2>
      </BlurFade>

      <BlurFade delay={0.2}>
        <a href={`mailto:${SITE_CONFIG.email}`} className="mt-8 font-mono text-[18px] text-text-secondary transition-colors duration-200 hover:text-text-primary">{SITE_CONFIG.email}</a>
      </BlurFade>

      <BlurFade delay={0.3}>
        <div className="mt-12 flex flex-wrap items-center justify-center gap-5 w-full sm:w-auto">
